...
<body>
    <header>
		...
		<h1>Items we recommend for you</h1>
		<p class="username">
    ...
    <section class="products">
		<?php
		$sql = 'SELECT i.item_id, i.item_name, i.price, i.amount, i.category, i.user_name, i.item_status FROM items i JOIN items_sold s ON i.category = s.category WHERE i.user_name <> s.user_name and s.user_name="' . $user_name . '"';
